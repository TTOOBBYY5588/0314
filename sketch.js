...
function setup() {   
  ...
  iframe.position(130, 100);
  iframe.size(windowWidth - 220, windowHeight - 220);
}
...
function draw() {
  background(220); // 設置背景顏色為灰色
  text("文字大小", 320, 20); // 在座標(360, 30)顯示文字「文字大小」
  // 根據滑桿的位置調整文字大小
  let textSizeValue = slider.value();
  textSize(textSizeValue);
  textAlign(LEFT, TOP);
  fill("#000000"); // 設置文字顏色為 #000000
